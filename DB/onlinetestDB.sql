...
-- -----------------------------------------------------
-- Table `onlinetestDB`.`grader`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `onlinetestDB`.`grader` (
...
CREATE INDEX `fk_user_id_idx` ON `onlinetestDB`.`grader` (`user_id` ASC);

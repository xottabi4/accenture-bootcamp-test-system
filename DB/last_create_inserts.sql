...
INSERT INTO `answer_text` VALUES (1,1,'Sunlight reaches Earth\'s atmosphere and is scattered in all directions by all the gases and particles in the air. Blue light is scattered in all directions by the tiny molecules of air in Earth\'s atmosphere. Blue is scattered more than other colors because it travels as shorter, smaller waves. This is why we see a blue sky most of the time.'),(3,3,'Yes'),(5,2,'class is an extensible program-code-template for creating objects'),(6,3,'Food, medicine');
...
INSERT INTO `question_option` VALUES (8,2,'Dog',1),(10,1,'4',1);
...
INSERT INTO `user_response` VALUES (1,1,1,'text answe','Blue light is shattered in all directions, like it goes through the prism'),(2,2,1,'Cat','selected option'),(3,3,1,'text answe','Yes'),(4,1,2,'4','selected option'),(5,2,2,'text answe','Class is a template for creating, or instantiating, specific objects within'),(6,3,2,'text answe','It is used as food');
...
-- Dump completed on 2016-07-06 15:40:14
